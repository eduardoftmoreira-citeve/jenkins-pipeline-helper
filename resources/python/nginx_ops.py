...
class NginxOps:
    ...
    def deploy_config(self, project, branch):
        ...
        run_command(f"mv {conf_name} {locations_dir}/", check=True)
        ...
        if test_result.returncode == 0:
            ...
            run_command(f"rm {locations_dir}/{conf_name}", check=False)
    ...
    def remove_config(self, project, branch):
        ...
        run_command(f"rm -f {locations_dir}/{conf_name}", check=False)
